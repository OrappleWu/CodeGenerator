 ...
 */
public class MapperCodeTemplate extends DaoCodeTemplate {
    private String rootFileCatalog;

    public MapperCodeTemplate(InputStream inputStream, String rootFileCatalog) {
    ...
    public FileWriter initFileWriter() {
        String fileName = CodeTemplateContext.getVal(AbstractCodeTemplate.ENTITY_NAME) + "Mapper.xml";
