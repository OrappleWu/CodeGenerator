 ...
 */
public class ControllerCodeTemplate extends DaoCodeTemplate {
    private String rootFileCatalog;

    public ControllerCodeTemplate(InputStream inputStream, String rootFileCatalog) {
    ...
    public FileWriter initFileWriter() {
        String fileName = CodeTemplateContext.getVal(AbstractCodeTemplate.ENTITY_NAME).concat("Controller.java");
