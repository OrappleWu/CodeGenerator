 ...
 */
public class BaseControllerCodeTemplate extends DaoCodeTemplate {
    private String rootFileCatalog;

    public BaseControllerCodeTemplate(InputStream inputStream, String rootFileCatalog) {
    ...
    public FileWriter initFileWriter() {
        ...
        String filePath = this.rootFileCatalog.concat("/main/java/") +
                this.transferPageNameToPath(CodeTemplateContext.getVal(AbstractCodeTemplate.ROOT_PACKAGE)) + "/base";
